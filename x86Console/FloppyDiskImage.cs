...
namespace x86Console
{
	public class FloppyDiskImage
	{
		...
		private MemoryAddress _address = new MemoryAddress(0x1000, 0x1000);
		...
		public void Add(OZone.Programs.Program program)
		{
			...
			if(_address.Offset <= 0x7000 && (_address.Offset + (blocks * _blockLength)) > 0x7000)
				_address.Offset = 0x8000;
