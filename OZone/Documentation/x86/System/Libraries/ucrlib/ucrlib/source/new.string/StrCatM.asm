		...
		echo	strcatm, strcatmcsi, strcatmstk

$SegStrings	segment	para public 'Strings'
		assume	cs:$segStrings, ds:nothing


; strcatm    -	Computes the lengths of two strings pointed at by es:di and
...
;
; outputs:
;		ES:DI- Points at new string containing the concatenation of
;               the two strings.
;
;		carry=0 if no error.
