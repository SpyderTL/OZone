...
<xsl:stylesheet
	...
	<xsl:template match="dbl:CreateObject">
		<scope>
			<cpu:PushSIToStack/>
			...
			<fpu:PullDoubleAtDIAddressFromST0/>
			...
			<addressOf ref="doubleClassName" type="Absolute32"/>
			...
			<var:string id="doubleClassName">http://metalx.org/Double</var:string>

			<label id="end"/>
		</scope>
	</xsl:template>

	<xsl:template match="dbl:ToString">
		<scope>
