...
<xsl:stylesheet
	...
	<xsl:template match="short:CreateObject">
		<scope>
			<cpu:PushSIToStack/>
			...
			<addressOf ref="shortClassName" type="Absolute32"/>
			...
			<var:string id="shortClassName">http://metalx.org/Short</var:string>

			<label id="end"/>
		</scope>
	</xsl:template>
	
	<xsl:template match="short:Parse">
		<scope>
	...
	<xsl:template match="short:ToString">
		<scope>
