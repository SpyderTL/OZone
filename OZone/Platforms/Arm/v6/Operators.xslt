...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:prg="http://metalx.org/Program" xmlns:ns="http://metalx.org/Arm/v6/Operators">
	...
	<xsl:template match="ns:Call">
		<xsl:choose>
			<xsl:when test="@condition">
				<ns:Call condition="{@condition}" prg:ref="{@ref}" prg:compile="false" prg:length="4"/>
			</xsl:when>
			<xsl:otherwise>
				<ns:Call prg:ref="{@ref}" prg:compile="false" prg:length="4"/>
			</xsl:otherwise>
		</xsl:choose>
	</xsl:template>

	<xsl:template match="ns:CopyRegister">
		<xsl:variable name="operator">27262976</xsl:variable>
		...
		<prg:uint>
			<xsl:value-of select="$condition + $operator + $setFlags + $destination + $register"/>
		</prg:uint>
	</xsl:template>
	...
	<xsl:template match="ns:Return">
		...
		<xsl:variable name="register">14</xsl:variable>

		<xsl:variable name="destination">
			<xsl:value-of select="15 * 4096"/>
		</xsl:variable>
	...
	<xsl:template match="ns:SetRegisterToValue">
		...
		<xsl:variable name="rotateRight">
			<xsl:choose>
				<xsl:when test="@rotateRight">
					<xsl:value-of select="floor(@rotateRight div 2) * 256"/>
				</xsl:when>
				<xsl:otherwise>0</xsl:otherwise>
			</xsl:choose>
		</xsl:variable>
		...
		<prg:uint>
			<xsl:value-of select="$condition + $operator + $setFlags + $register + $rotateRight + $value"/>
		</prg:uint>
	</xsl:template>
	...
	<xsl:template match="ns:CopyRegisterToAddress8">
		...
		<prg:uint>
			<xsl:value-of select="$condition + $operator + $addressRegister + $register + $offset"/>
		</prg:uint>
	</xsl:template>

	<xsl:template match="ns:CopyAddressToRegister8">
		<xsl:variable name="operator">97517568</xsl:variable>
		<xsl:variable name="addressRegister" select="@addressRegister * 65536"/>
		<xsl:variable name="register" select="@register * 4096"/>
		<xsl:variable name="offset">
			<xsl:choose>
	...
	<xsl:template match="ns:CopyRegisterToAddress32">
		<xsl:variable name="operator">92274688</xsl:variable>
		<xsl:variable name="addressRegister" select="@addressRegister * 65536"/>
		<xsl:variable name="register" select="@register * 4096"/>
		<xsl:variable name="offset">
			<xsl:choose>
	...
	<xsl:template match="ns:CopyAddressToRegister32">
		<xsl:variable name="operator">93323264</xsl:variable>
		<xsl:variable name="addressRegister" select="@addressRegister * 65536"/>
		<xsl:variable name="register" select="@register * 4096"/>
		<xsl:variable name="offset">
			<xsl:choose>
	...
	<xsl:template match="ns:CopyRegisterToCoprocessor">
		<xsl:variable name="operator">234884880</xsl:variable>
		<xsl:variable name="register" select="@register * 4096"/>
		<xsl:variable name="coprocessorRegister" select="@coprocessorRegister * 65536"/>
		
		<xsl:variable name="opcode">
			<xsl:choose>
				<xsl:when test="@opcode">
					<xsl:value-of select="@opcode * 2097152"/>
				</xsl:when>
				<xsl:otherwise>0</xsl:otherwise>
			</xsl:choose>
		</xsl:variable>
		
		<xsl:variable name="opcode2">
			<xsl:choose>
				<xsl:when test="@opcode2">
					<xsl:value-of select="@opcode2 * 32"/>
				</xsl:when>
				<xsl:otherwise>0</xsl:otherwise>
			</xsl:choose>
		</xsl:variable>
		...
		<prg:uint>
			<xsl:value-of select="$condition + $operator + $coprocessorRegister + $register + $opcode + $opcode2"/>
		</prg:uint>
	</xsl:template>

	<xsl:template match="ns:CopyCoprocessorToRegister">
		<xsl:variable name="operator">235933456</xsl:variable>
		<xsl:variable name="register" select="@register * 4096"/>
		<xsl:variable name="coprocessorRegister" select="@coprocessorRegister * 65536"/>
	...
	<xsl:template match="ns:CopyRegisterToStatus">
		<xsl:variable name="operator">18935808</xsl:variable>
		<xsl:variable name="register" select="@register"/>
		<xsl:variable name="flags">524288</xsl:variable>
		<xsl:variable name="status">262144</xsl:variable>
		<xsl:variable name="extension">131072</xsl:variable>
		<xsl:variable name="control">65536</xsl:variable>
		...
		<prg:uint>
			<xsl:value-of select="$condition + $operator + $flags + $status + $extension + $control + $register"/>
		</prg:uint>
	</xsl:template>

	<xsl:template match="ns:CopyStatusToRegister">
		<xsl:variable name="operator">17760256</xsl:variable>
		<xsl:variable name="register" select="@register * 4096"/>
		...
		<prg:uint>
			<xsl:value-of select="$condition + $operator + $register"/>
		</prg:uint>
	</xsl:template>
	...
	<xsl:template match="ns:AddValueToRegister">
		...
		<prg:uint>
			<xsl:value-of select="$condition + $operator + $setFlags + $register + $destination + $rotateRight + $value"/>
		</prg:uint>
	</xsl:template>
	...
	<xsl:template match="ns:AndRegisterWithValue">
		<xsl:variable name="operator">33554432</xsl:variable>
	...
	<xsl:template match="ns:NotRegisterWithValue">
		<xsl:variable name="operator">62914560</xsl:variable>
	...
	<xsl:template match="ns:OrRegisterWithValue">
		<xsl:variable name="operator">58720256</xsl:variable>
	...
	<xsl:template match="ns:TestAndRegisterWithValue">
		<xsl:variable name="operator">51380224</xsl:variable>
		...
		<prg:uint>
			<xsl:value-of select="$condition + $operator + $register + $rotateRight + $value"/>
		</prg:uint>
	</xsl:template>

	<xsl:template match="ns:TestExclusiveOrRegisterWithValue">
		<xsl:variable name="operator">53477376</xsl:variable>
	...
	<xsl:template match="ns:TestSubtractValueFromRegister">
		<xsl:variable name="operator">54525952</xsl:variable>
	...
	<xsl:template match="ns:TestAddValueToRegister">
		<xsl:variable name="operator">56623104</xsl:variable>
