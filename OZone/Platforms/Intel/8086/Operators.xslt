...
<xsl:stylesheet version="1.0" xmlns="http://metalx.org/Program" xmlns:cpu="http://metalx.org/Intel/8086/Operators" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="cpu:ExtendOperator">
  ...
  <xsl:template match="cpu:AddRegisterToOperandWithCarry16">
  ...
  <xsl:template match="cpu:AddOperandToRegisterWithCarry16">
  ...
  <xsl:template match="cpu:SubtractRegisterFromOperandWithBorrow16">
  ...
  <xsl:template match="cpu:SubtractOperandFromRegisterWithBorrow16">
  ...
  <xsl:template match="cpu:SubtractRegisterFromOperand16">
  ...
  <xsl:template match="cpu:SubtractOperandFromRegister16">
  ...
  <xsl:template match="cpu:ExclusiveOrOperandWithRegister16">
  ...
  <xsl:template match="cpu:ExclusiveOrRegisterWithOperand16">
  ...
  <xsl:template match="cpu:PushImmediateToStack16">
    <xsl:element name="hex">68</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:SetRegisterToOperandMultipliedByImmediateSigned16">
  ...
  <xsl:template match="cpu:ReadFromDXPortToDIAddressAndIncrementDI16">
  ...
  <xsl:template match="cpu:WriteSIAddressToDXPortAndIncrementSI16">
    <xsl:element name="hex">6F</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfOverflow8">
    <xsl:element name="hex">70</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfNotOverflow8">
    <xsl:element name="hex">71</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfBelow8">
    <xsl:element name="hex">72</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfNotAboveOrEqual8">
    <xsl:element name="hex">72</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfCarry8">
    <xsl:element name="hex">72</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfAboveOrEqual8">
    <xsl:element name="hex">73</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfNotBelow8">
    <xsl:element name="hex">73</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfNotCarry8">
    <xsl:element name="hex">73</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfZero8">
    <xsl:element name="hex">74</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfEqual8">
    <xsl:element name="hex">74</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfNotZero8">
    <xsl:element name="hex">75</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfNotEqual8">
    <xsl:element name="hex">75</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfBelowOrEqual8">
    <xsl:element name="hex">76</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfNotAbove8">
    <xsl:element name="hex">76</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfAbove8">
    <xsl:element name="hex">77</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfNotBelowOrEqual8">
    <xsl:element name="hex">77</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfPositive8">
    <xsl:element name="hex">78</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfNegative8">
    <xsl:element name="hex">79</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfEven8">
    <xsl:element name="hex">7A</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfOdd8">
    <xsl:element name="hex">7B</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfLess8">
    <xsl:element name="hex">7C</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfNotGreaterOrEqual8">
    <xsl:element name="hex">7C</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfNotLess8">
    <xsl:element name="hex">7D</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfGreaterOrEqual8">
    <xsl:element name="hex">7D</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfLessOrEqual8">
    <xsl:element name="hex">7E</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfNotGreater8">
    <xsl:element name="hex">7E</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfNotLessOrEqual8">
    <xsl:element name="hex">7F</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfGreater8">
    <xsl:element name="hex">7F</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:TestOperandWithRegister8">
    <xsl:element name="hex">84</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:TestOperandWithRegister16">
  ...
  <xsl:template match="cpu:CallImmediatePointer16">
    <xsl:element name="hex">9A</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:HandleFloatingPointExceptions">
  ...
  <xsl:template match="cpu:CopySIAddressToDIAddressAndIncrementSIAndDI16">
  ...
  <xsl:template match="cpu:CompareSIAddressToDIAddressAndIncrementSIAndDI16">
  ...
  <xsl:template match="cpu:SetESAndRegisterToFarPointer16">
    <xsl:element name="hex">C4</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:SetDSAndRegisterToFarPointer16">
  ...
  <xsl:template match="cpu:LoopToRelativeWhileNotEqual8">
    <xsl:element name="hex">E0</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:LoopToRelativeWhileNotZero8">
    <xsl:element name="hex">E0</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:LoopToRelativeWhileEqual8">
    <xsl:element name="hex">E1</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:LoopToRelativeWhileZero8">
    <xsl:element name="hex">E1</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:LoopToRelative8">
    <xsl:element name="hex">E2</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:BranchToRelativeIfCXIsZero">
  ...
  <xsl:template match="cpu:CallRelative16">
    <xsl:element name="hex">E8</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:JumpToRelative16">
    <xsl:element name="hex">E9</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:JumpToImmediatePointer16">
  ...
  <xsl:template match="cpu:MathImmediateToOperandFunction16">
    <xsl:element name="hex">81</xsl:element>
  </xsl:template>
  <xsl:template match="cpu:MathImmediate8ToOperand16Function">
  ...
  <xsl:template match="cpu:CopyImmediateToOperandFunction16">
  ...
  <xsl:template match="cpu:IncrementFunction16">
