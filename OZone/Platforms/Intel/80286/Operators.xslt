...
<xsl:stylesheet version="1.0" xmlns:ns="http://metalx.org/Intel/80286/Operators" xmlns:prg="http://metalx.org/Program" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="ns:AddRegisterToOperand16">
	...
	<xsl:template match="ns:AddOperandToRegister16">
	...
	<xsl:template match="ns:OrOperandWithRegister16">
	...
	<xsl:template match="ns:OrRegisterWithOperand16">
	...
	<xsl:template match="ns:AddRegisterToOperandWithCarry16">
	...
	<xsl:template match="ns:AddOperandToRegisterWithCarry16">
	...
	<xsl:template match="ns:SubtractRegisterFromOperandWithBorrow16">
	...
	<xsl:template match="ns:SubtractOperandFromRegisterWithBorrow16">
	...
	<xsl:template match="ns:AndOperandWithRegister16">
	...
	<xsl:template match="ns:AndRegisterWithOperand16">
	...
	<xsl:template match="ns:SubtractRegisterFromOperand16">
	...
	<xsl:template match="ns:SubtractOperandFromRegister16">
	...
	<xsl:template match="ns:ExclusiveOrOperandWithRegister16">
	...
	<xsl:template match="ns:ExclusiveOrRegisterWithOperand16">
	...
	<xsl:template match="ns:CompareOperandToRegister16">
	...
	<xsl:template match="ns:CompareRegisterToOperand16">
	...
	<xsl:template match="ns:PushImmediateToStack16">
		<xsl:element name="prg:hex">68</xsl:element>
	</xsl:template>
	<xsl:template match="ns:SetRegisterToOperandMultipliedByImmediateSigned16">
	...
	<xsl:template match="ns:ReadFromDXPortToDIAddressAndIncrementDI16">
	...
	<xsl:template match="ns:WriteSIAddressToDXPortAndIncrementSI16">
	...
	<xsl:template match="ns:TestOperandWithRegister16">
	...
	<xsl:template match="ns:ExchangeOperandWithRegister16">
	...
	<xsl:template match="ns:CopyRegisterToOperand16">
	...
	<xsl:template match="ns:CopyOperandToRegister16">
		<xsl:element name="prg:hex">8B</xsl:element>
	</xsl:template>
	<xsl:template match="ns:CopySegmentRegisterToOperand16">
		<xsl:element name="prg:hex">8C</xsl:element>
	</xsl:template>
	<xsl:template match="ns:SetRegisterToEffectiveAddress16">
		<xsl:element name="prg:hex">8D</xsl:element>
	</xsl:template>
	<xsl:template match="ns:CopyOperandToSegmentRegister16">
	...
	<xsl:template match="ns:CallImmediatePointer16">
	...
	<xsl:template match="ns:CopySIAddressToDIAddressAndIncrementSIAndDI16">
	...
	<xsl:template match="ns:CompareSIAddressToDIAddressAndIncrementSIAndDI16">
	...
	<xsl:template match="ns:SetESAndRegisterToFarPointer16">
		<xsl:element name="prg:hex">C4</xsl:element>
	</xsl:template>
	<xsl:template match="ns:SetDSAndRegisterToFarPointer16">
	...
	<xsl:template match="ns:SetALToDSBXPlusAL">
	...
	<xsl:template match="ns:CallRelative16">
		<xsl:element name="prg:hex">E8</xsl:element>
	</xsl:template>
	<xsl:template match="ns:JumpToRelative16">
		<xsl:element name="prg:hex">E9</xsl:element>
	</xsl:template>
	<xsl:template match="ns:JumpToImmediatePointer16">
	...
	<xsl:template match="ns:HaltProcessing">
	...
	<xsl:template match="ns:MathImmediateToOperandFunction16">
		<xsl:element name="prg:hex">81</xsl:element>
	</xsl:template>
	<xsl:template match="ns:MathImmediate8ToOperand16Function">
	...
	<xsl:template match="ns:ShiftRegister16ByImmediate8Function">
	...
	<xsl:template match="ns:ShiftRegisterByOneFunction16">
	...
	<xsl:template match="ns:ShiftRegisterByCLFunction16">
	...
	<xsl:template match="ns:CopyImmediateToOperandFunction16">
	...
	<xsl:template match="ns:IncrementFunction16">
