...
<xsl:stylesheet version="1.0" xmlns:ns="http://metalx.org/Intel/80286/Segments" xmlns:prg="http://metalx.org/Program" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="ns:ES-BXPlusSIAddress">
		<xsl:element name="prg:hex">00</xsl:element>
	</xsl:template>
	<xsl:template match="ns:ES-BXPlusDIAddress">
		<xsl:element name="prg:hex">01</xsl:element>
	</xsl:template>
	<xsl:template match="ns:ES-BPPlusSIAddress">
		<xsl:element name="prg:hex">02</xsl:element>
	</xsl:template>
	<xsl:template match="ns:ES-BPPlusDIAddress">
	...
	<xsl:template match="ns:CS-BXPlusSIAddress">
		<xsl:element name="prg:hex">08</xsl:element>
	</xsl:template>
	<xsl:template match="ns:CS-BXPlusDIAddress">
		<xsl:element name="prg:hex">09</xsl:element>
	</xsl:template>
	<xsl:template match="ns:CS-BPPlusSIAddress">
		<xsl:element name="prg:hex">0A</xsl:element>
	</xsl:template>
	<xsl:template match="ns:CS-BPPlusDIAddress">
	...
	<xsl:template match="ns:SS-BXPlusSIAddress">
		<xsl:element name="prg:hex">10</xsl:element>
	</xsl:template>
	<xsl:template match="ns:SS-BXPlusDIAddress">
		<xsl:element name="prg:hex">11</xsl:element>
	</xsl:template>
	<xsl:template match="ns:SS-BPPlusSIAddress">
		<xsl:element name="prg:hex">12</xsl:element>
	</xsl:template>
	<xsl:template match="ns:SS-BPPlusDIAddress">
	...
	<xsl:template match="ns:DS-BXPlusSIAddress">
		<xsl:element name="prg:hex">18</xsl:element>
	</xsl:template>
	<xsl:template match="ns:DS-BXPlusDIAddress">
		<xsl:element name="prg:hex">19</xsl:element>
	</xsl:template>
	<xsl:template match="ns:DS-BPPlusSIAddress">
		<xsl:element name="prg:hex">1A</xsl:element>
	</xsl:template>
	<xsl:template match="ns:DS-BPPlusDIAddress">
	...
	<xsl:template match="ns:FS-BXPlusSIAddress">
		<xsl:element name="prg:hex">20</xsl:element>
	</xsl:template>
	<xsl:template match="ns:FS-BXPlusDIAddress">
		<xsl:element name="prg:hex">21</xsl:element>
	</xsl:template>
	<xsl:template match="ns:FS-BPPlusSIAddress">
		<xsl:element name="prg:hex">22</xsl:element>
	</xsl:template>
	<xsl:template match="ns:FS-BPPlusDIAddress">
	...
	<xsl:template match="ns:GS-BXPlusSIAddress">
		<xsl:element name="prg:hex">28</xsl:element>
	</xsl:template>
	<xsl:template match="ns:GS-BXPlusDIAddress">
		<xsl:element name="prg:hex">29</xsl:element>
	</xsl:template>
	<xsl:template match="ns:GS-BPPlusSIAddress">
		<xsl:element name="prg:hex">2A</xsl:element>
	</xsl:template>
	<xsl:template match="ns:GS-BPPlusDIAddress">
	...
	<xsl:template match="ns:ES-BXPlusSIAddressPlusImmediate8">
		<xsl:element name="prg:hex">40</xsl:element>
	</xsl:template>
	<xsl:template match="ns:ES-BXPlusDIAddressPlusImmediate8">
		<xsl:element name="prg:hex">41</xsl:element>
	</xsl:template>
	<xsl:template match="ns:ES-BPPlusSIAddressPlusImmediate8">
		<xsl:element name="prg:hex">42</xsl:element>
	</xsl:template>
	<xsl:template match="ns:ES-BPPlusDIAddressPlusImmediate8">
	...
	<xsl:template match="ns:CS-BXPlusSIAddressPlusImmediate8">
		<xsl:element name="prg:hex">48</xsl:element>
	</xsl:template>
	<xsl:template match="ns:CS-BXPlusDIAddressPlusImmediate8">
		<xsl:element name="prg:hex">49</xsl:element>
	</xsl:template>
	<xsl:template match="ns:CS-BPPlusSIAddressPlusImmediate8">
		<xsl:element name="prg:hex">4A</xsl:element>
	</xsl:template>
	<xsl:template match="ns:CS-BPPlusDIAddressPlusImmediate8">
	...
	<xsl:template match="ns:SS-BXPlusSIAddressPlusImmediate8">
		<xsl:element name="prg:hex">50</xsl:element>
	</xsl:template>
	<xsl:template match="ns:SS-BXPlusDIAddressPlusImmediate8">
		<xsl:element name="prg:hex">51</xsl:element>
	</xsl:template>
	<xsl:template match="ns:SS-BPPlusSIAddressPlusImmediate8">
		<xsl:element name="prg:hex">52</xsl:element>
	</xsl:template>
	<xsl:template match="ns:SS-BPPlusDIAddressPlusImmediate8">
	...
	<xsl:template match="ns:DS-BXPlusSIAddressPlusImmediate8">
		<xsl:element name="prg:hex">58</xsl:element>
	</xsl:template>
	<xsl:template match="ns:DS-BXPlusDIAddressPlusImmediate8">
		<xsl:element name="prg:hex">59</xsl:element>
	</xsl:template>
	<xsl:template match="ns:DS-BPPlusSIAddressPlusImmediate8">
		<xsl:element name="prg:hex">5A</xsl:element>
	</xsl:template>
	<xsl:template match="ns:DS-BPPlusDIAddressPlusImmediate8">
	...
	<xsl:template match="ns:FS-BXPlusSIAddressPlusImmediate8">
		<xsl:element name="prg:hex">60</xsl:element>
	</xsl:template>
	<xsl:template match="ns:FS-BXPlusDIAddressPlusImmediate8">
		<xsl:element name="prg:hex">61</xsl:element>
	</xsl:template>
	<xsl:template match="ns:FS-BPPlusSIAddressPlusImmediate8">
		<xsl:element name="prg:hex">62</xsl:element>
	</xsl:template>
	<xsl:template match="ns:FS-BPPlusDIAddressPlusImmediate8">
	...
	<xsl:template match="ns:GS-BXPlusSIAddressPlusImmediate8">
		<xsl:element name="prg:hex">68</xsl:element>
	</xsl:template>
	<xsl:template match="ns:GS-BXPlusDIAddressPlusImmediate8">
		<xsl:element name="prg:hex">69</xsl:element>
	</xsl:template>
	<xsl:template match="ns:GS-BPPlusSIAddressPlusImmediate8">
		<xsl:element name="prg:hex">6A</xsl:element>
	</xsl:template>
	<xsl:template match="ns:GS-BPPlusDIAddressPlusImmediate8">
	...
	<xsl:template match="ns:ES-BXPlusSIAddressPlusImmediate16">
		<xsl:element name="prg:hex">80</xsl:element>
	</xsl:template>
	<xsl:template match="ns:ES-BXPlusDIAddressPlusImmediate16">
		<xsl:element name="prg:hex">81</xsl:element>
	</xsl:template>
	<xsl:template match="ns:ES-BPPlusSIAddressPlusImmediate16">
		<xsl:element name="prg:hex">82</xsl:element>
	</xsl:template>
	<xsl:template match="ns:ES-BPPlusDIAddressPlusImmediate16">
		<xsl:element name="prg:hex">83</xsl:element>
	</xsl:template>
	<xsl:template match="ns:ES-SIAddressPlusImmediate16">
		<xsl:element name="prg:hex">84</xsl:element>
	</xsl:template>
	<xsl:template match="ns:ES-DIAddressPlusImmediate16">
		<xsl:element name="prg:hex">85</xsl:element>
	</xsl:template>
	<xsl:template match="ns:ES-BPAddressPlusImmediate16">
		<xsl:element name="prg:hex">86</xsl:element>
	</xsl:template>
	<xsl:template match="ns:ES-BXAddressPlusImmediate16">
		<xsl:element name="prg:hex">87</xsl:element>
	</xsl:template>
	<xsl:template match="ns:CS-BXPlusSIAddressPlusImmediate16">
		<xsl:element name="prg:hex">88</xsl:element>
	</xsl:template>
	<xsl:template match="ns:CS-BXPlusDIAddressPlusImmediate16">
		<xsl:element name="prg:hex">89</xsl:element>
	</xsl:template>
	<xsl:template match="ns:CS-BPPlusSIAddressPlusImmediate16">
		<xsl:element name="prg:hex">8A</xsl:element>
	</xsl:template>
	<xsl:template match="ns:CS-BPPlusDIAddressPlusImmediate16">
		<xsl:element name="prg:hex">8B</xsl:element>
	</xsl:template>
	<xsl:template match="ns:CS-SIAddressPlusImmediate16">
		<xsl:element name="prg:hex">8C</xsl:element>
	</xsl:template>
	<xsl:template match="ns:CS-DIAddressPlusImmediate16">
		<xsl:element name="prg:hex">8D</xsl:element>
	</xsl:template>
	<xsl:template match="ns:CS-BPAddressPlusImmediate16">
		<xsl:element name="prg:hex">8E</xsl:element>
	</xsl:template>
	<xsl:template match="ns:CS-BXAddressPlusImmediate16">
		<xsl:element name="prg:hex">8F</xsl:element>
	</xsl:template>
	<xsl:template match="ns:SS-BXPlusSIAddressPlusImmediate16">
		<xsl:element name="prg:hex">90</xsl:element>
	</xsl:template>
	<xsl:template match="ns:SS-BXPlusDIAddressPlusImmediate16">
		<xsl:element name="prg:hex">91</xsl:element>
	</xsl:template>
	<xsl:template match="ns:SS-BPPlusSIAddressPlusImmediate16">
		<xsl:element name="prg:hex">92</xsl:element>
	</xsl:template>
	<xsl:template match="ns:SS-BPPlusDIAddressPlusImmediate16">
		<xsl:element name="prg:hex">93</xsl:element>
	</xsl:template>
	<xsl:template match="ns:SS-SIAddressPlusImmediate16">
		<xsl:element name="prg:hex">94</xsl:element>
	</xsl:template>
	<xsl:template match="ns:SS-DIAddressPlusImmediate16">
		<xsl:element name="prg:hex">95</xsl:element>
	</xsl:template>
	<xsl:template match="ns:SS-BPAddressPlusImmediate16">
		<xsl:element name="prg:hex">96</xsl:element>
	</xsl:template>
	<xsl:template match="ns:SS-BXAddressPlusImmediate16">
		<xsl:element name="prg:hex">97</xsl:element>
	</xsl:template>
	<xsl:template match="ns:DS-BXPlusSIAddressPlusImmediate16">
		<xsl:element name="prg:hex">98</xsl:element>
	</xsl:template>
	<xsl:template match="ns:DS-BXPlusDIAddressPlusImmediate16">
		<xsl:element name="prg:hex">99</xsl:element>
	</xsl:template>
	<xsl:template match="ns:DS-BPPlusSIAddressPlusImmediate16">
		<xsl:element name="prg:hex">9A</xsl:element>
	</xsl:template>
	<xsl:template match="ns:DS-BPPlusDIAddressPlusImmediate16">
		<xsl:element name="prg:hex">9B</xsl:element>
	</xsl:template>
	<xsl:template match="ns:DS-SIAddressPlusImmediate16">
		<xsl:element name="prg:hex">9C</xsl:element>
	</xsl:template>
	<xsl:template match="ns:DS-DIAddressPlusImmediate16">
		<xsl:element name="prg:hex">9D</xsl:element>
	</xsl:template>
	<xsl:template match="ns:DS-BPAddressPlusImmediate16">
		<xsl:element name="prg:hex">9E</xsl:element>
	</xsl:template>
	<xsl:template match="ns:DS-BXAddressPlusImmediate16">
		<xsl:element name="prg:hex">9F</xsl:element>
	</xsl:template>
	<xsl:template match="ns:FS-BXPlusSIAddressPlusImmediate16">
		<xsl:element name="prg:hex">A0</xsl:element>
	</xsl:template>
	<xsl:template match="ns:FS-BXPlusDIAddressPlusImmediate16">
		<xsl:element name="prg:hex">A1</xsl:element>
	</xsl:template>
	<xsl:template match="ns:FS-BPPlusSIAddressPlusImmediate16">
		<xsl:element name="prg:hex">A2</xsl:element>
	</xsl:template>
	<xsl:template match="ns:FS-BPPlusDIAddressPlusImmediate16">
		<xsl:element name="prg:hex">A3</xsl:element>
	</xsl:template>
	<xsl:template match="ns:FS-SIAddressPlusImmediate16">
		<xsl:element name="prg:hex">A4</xsl:element>
	</xsl:template>
	<xsl:template match="ns:FS-DIAddressPlusImmediate16">
		<xsl:element name="prg:hex">A5</xsl:element>
	</xsl:template>
	<xsl:template match="ns:FS-BPAddressPlusImmediate16">
		<xsl:element name="prg:hex">A6</xsl:element>
	</xsl:template>
	<xsl:template match="ns:FS-BXAddressPlusImmediate16">
		<xsl:element name="prg:hex">A7</xsl:element>
	</xsl:template>
	<xsl:template match="ns:GS-BXPlusSIAddressPlusImmediate16">
		<xsl:element name="prg:hex">A8</xsl:element>
	</xsl:template>
	<xsl:template match="ns:GS-BXPlusDIAddressPlusImmediate16">
		<xsl:element name="prg:hex">A9</xsl:element>
	</xsl:template>
	<xsl:template match="ns:GS-BPPlusSIAddressPlusImmediate16">
		<xsl:element name="prg:hex">AA</xsl:element>
	</xsl:template>
	<xsl:template match="ns:GS-BPPlusDIAddressPlusImmediate16">
		<xsl:element name="prg:hex">AB</xsl:element>
	</xsl:template>
	<xsl:template match="ns:GS-SIAddressPlusImmediate16">
		<xsl:element name="prg:hex">AC</xsl:element>
	</xsl:template>
	<xsl:template match="ns:GS-DIAddressPlusImmediate16">
		<xsl:element name="prg:hex">AD</xsl:element>
	</xsl:template>
	<xsl:template match="ns:GS-BPAddressPlusImmediate16">
		<xsl:element name="prg:hex">AE</xsl:element>
	</xsl:template>
	<xsl:template match="ns:GS-BXAddressPlusImmediate16">
