...
{
	public class CartridgeImage
	{
		private List<CartridgeImageProgram> _programs = new List<CartridgeImageProgram>();
		...
		private struct CartridgeImageProgram
		{
			public int Block;
			public int Length;
